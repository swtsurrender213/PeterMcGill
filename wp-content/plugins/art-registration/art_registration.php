<?php
    /*
    Plugin Name: Art Registration
    Plugin URI: http://www.jts.name
    Description: Plugin for a art registration page
...
} //end partist_load_css

add_action('wp_enqueue_scripts','partist_load_scripts');
...
<?php } //end show_art_registration_form
...
} //end art registration main program
//[ar]
add_shortcode('ar', 'art_registration_shortcode');


function art_registration_shortcode(){
